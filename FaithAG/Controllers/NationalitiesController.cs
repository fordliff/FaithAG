...
namespace FaithAG.Controllers
{
    public class NationalitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Country,CountryCode,Nationality1,Id")] Nationality nationality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Country,CountryCode,Nationality1,Id")] Nationality nationality)
        {
            if (ModelState.IsValid)
            {
